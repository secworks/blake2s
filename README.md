[![build-openlane-sky130](https://github.com/secwporks/blake2s/actions/workflows/ci.yaml/badge.svg?branch=main&event=push)](https://github.com/secworks/blake2s/actions/workflows/ci.yaml)
